...
# Divisão em duas colunas
    ...
    if not df_desempenho.empty and "Desempenho Médio Ajustado" in df_desempenho.columns:
        ...
        st.markdown("<h2 style='text-align: center; font-size: 16px;'>🏆 Top 3 Melhores Desempenhos 🏆</h2>", unsafe_allow_html=True)
        ...
        st.markdown("<h3 style='text-align: left; font-size: 16px;'>🏇 Desempenho das Outras Equipes</h3>", unsafe_allow_html=True)
...
# --- Aposta Top 3 ---
    ...
    if not df_cavalos_filtrado.empty:
        ...
        # ✅ Exibir DataFrame atualizado para validar os cálculos
