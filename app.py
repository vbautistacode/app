...
with col2:
    if not df_cavalos.empty and "Adjusted Bet" in df_cavalos.columns:
        ...
        st.write("📊 **Média das apostas:**", round(media_apostas, 2))
        st.write("📉 **Desvio padrão das apostas:**", round(desvio_apostas, 2))
